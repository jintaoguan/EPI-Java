...
public class problem_06_04 {
    ...
    public int find_sum_two_pairs( int[] A ) {
        if( A.length <= 1 ) 
            return 0;
    ...
    public int find_sum_k_pairs( int[] A, int k ) {
    ...
    public static void main(String[] argv) {
        ...
        System.out.println( solutions.find_sum_two_pairs(A) );
        System.out.println( solutions.find_sum_k_pairs(A,3) );
    }
